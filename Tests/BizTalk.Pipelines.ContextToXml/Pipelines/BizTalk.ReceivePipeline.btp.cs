namespace BizTalk.Pipelines.ContextToXml.Pipelines
{
    ...
    public sealed class BizTalk_ReceivePipeline : Microsoft.BizTalk.PipelineOM.ReceivePipeline
    {
...
"6\" />      <Components>        <Component>          <Name>BizTalkComponents.PipelineComponents.Conte"+
"xtToXml,BizTalk.PipelineComponents.ContextToXml, Version=1.0.0.0, Culture=neutral, PublicKeyToken=47"+
"190f56632fbc76</Name>          <ComponentName>Context to Xml</ComponentName>          <Description>P"+
"ipeline Component that coverts context to a xm message. Original message will be descarded</Descript"+
"ion>          <Version>1.0.0</Version>          <Properties />          <CachedDisplayName>Context t"+
"o Xml</CachedDisplayName>          <CachedIsManaged>true</CachedIsManaged>        </Component>      "+
...
"tNamespaces</Value>    </Property>  </Properties></PropertyBag>";
            ...
            IBaseComponent comp1 = Microsoft.BizTalk.PipelineOM.PipelineManager.CreateComponent("BizTalkComponents.PipelineComponents.ContextToXml,BizTalk.PipelineComponents.ContextToXml, Version=1.0.0.0, Culture=neutral, PublicKeyToken=47190f56632fbc76");;
